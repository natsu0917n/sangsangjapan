    ...
    <footer class="l-footer" data-transition>
      <div class="l-footer__inner">
        ...
        <div class="l-footer__sns">
          ...
          <a class="l-footer__sns-link" href="<?php echo esc_url($instagram_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <?php endif; ?>
          <?php if ($facebook_url) : ?>
          <a class="l-footer__sns-link" href="<?php echo esc_url($facebook_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
          ...
          <?php endif; ?>
          <?php if ($twitter_url) : ?>
          <a class="l-footer__sns-link" href="<?php echo esc_url($twitter_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          <?php endif; ?>
          <?php if ($line_url) : ?>
          <a class="l-footer__sns-link" href="<?php echo esc_url($line_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="LINE">
          ...
          <?php endif; ?>
          <?php if ($tiktok_url) : ?>
          <a class="l-footer__sns-link" href="<?php echo esc_url($tiktok_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
